...
Plugins that shape how you plan, build, test, and ship code.
...
Specialist agents and skills for writing code across languages and frameworks.
...
Guard your projects against dependency attacks and enforce governance.

| Plugin | Version | Description |
|--------|---------|-------------|
| [supply-chain-defence](plugins/supply-chain-defence) | 0.2.0 | Protect npm/pnpm/yarn/bun projects from supply chain attacks with deterministic hook-based guards<br><sub>🛠 3 skills · 📋 2 commands</sub> |
...
Write docs, design systems, generate images, and craft writing voices.
...
| [image-gen](plugins/image-gen) | 0.1.1 | AI-powered image generation using Google Gemini models via nanobanana MCP server<br><sub>🛠 1 skill</sub> |
...
Plugin management, diagnostics, and settings presets.

| Plugin | Version | Description |
|--------|---------|-------------|
| [utils](plugins/utils) | 0.9.1 | Plugin management utilities: dependency checking, scanning, and root resolution<br><sub>🛠 5 skills</sub> |
